...
const OriginalBrands2 = () => {
  ...
  return (
    <div className="block lg:hidden w-full flex justify-center bg-transparent">
      <div className="w-[375px] max-w-full p-4 border border-gray-200 bg-white shadow-lg relative">
