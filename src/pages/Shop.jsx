...
const Shop = () => {
  ...
  return (
    <>
      ...
      <div className='flex flex-row items-center justify-center bg-blue-300 h-full w-[95%] m-auto'>
        <div className='flex-1 h-full bg-amber-600 flex items-start'>left area</div>
